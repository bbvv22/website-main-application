...
const TaglineSection = () => {
  ...
  return (
    <div className="relative bg-white text-black min-h-[calc(70vh-5rem)] flex items-center justify-center text-center px-6 pt-28 md:pt-44">
  <motion.div
  ...
  >
    ...
    <h1 className="text-4xl md:text-7xl font-serif text-black mb-6 leading-tight">
      Who better than you
    </h1>
