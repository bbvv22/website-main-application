...
export const CartProvider = ({ children }) => {
  ...
  const applyCoupon = (couponCode, cartTotal) => {
    // TODO: For production, this coupon logic should be moved to the backend
    // to prevent client-side manipulation and ensure security.
    // The frontend should send the coupon code to the backend, and the backend
    // should return the discount amount and a message.
